...
def upgrade() -> None:
    ...
    op.create_table('medical_bed_type',
    sa.Column('name', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_medical_bed_type_name'), 'medical_bed_type', ['name'], unique=True)
    ...
    op.create_table('doctor_medical_specialty_link',
    ...
    sa.ForeignKeyConstraint(['medical_specialty'], ['medical_specialty.id'], ),
    sa.PrimaryKeyConstraint('doctor', 'medical_specialty')
    )
    op.create_table('medical_bed',
    sa.Column('name', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('status', sa.Enum('AVAILABLE', 'UNAVAILABLE', name='medicalbedstatus'), nullable=False),
    sa.Column('medical_bed_type_id', sa.Integer(), nullable=False),
    sa.Column('hospital_id', sa.Integer(), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['hospital_id'], ['hospital.id'], ),
    sa.ForeignKeyConstraint(['medical_bed_type_id'], ['medical_bed_type.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('transference_request',
    ...
    sa.ForeignKeyConstraint(['requesting_doctor_id'], ['doctor.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
